...
function argParse(): Array<any>{
    const args = process.argv.slice(2);
    // do stuff with args
    // ...
    const data: Array<any> = [0.8, null, 10800, 112000.0, [70000, 80000, 85000, 90000, 95000, 100000, 105000, 110000, 120000]];
    for (const [i, a] of args.entries()){
        if (a === "-h" || a === "--help"){
            ...
            args.forEach(element[, i[, args]] => console.log("${element}, ${i}"));
